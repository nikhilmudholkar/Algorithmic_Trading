...
def sup_res_calculator(h, date):
	...
	# h = hist[-1000:].Close
	# date = hist[-1000:].Date
	(miniIdxs, pmin, mintrend, minwindows), (maximaIdxs, pmax, maxtrend, maxwindows) = trendln.calc_support_resistance(h,
	...
	# S_and_R = {}
	# S_and_R['support'] = support_prices
	# S_and_R['resistance'] = resistance_prices
